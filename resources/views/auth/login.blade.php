        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="collapsibleNavId">
              ...
              <form class="d-flex my-2 my-lg-0">
                  <a href="{{ route('register') }}" class="btn me-3 fw-bold px-4" style="background-color: #5C8374; color: #ffffff; border-radius: 100px;" type="button">Register</a>
              </form>
          </div>
    </div>
  </nav>
    ...
    <div class="container d-flex justify-content-center align-items-center mt-5">
        <div class="card col-lg-5 col-md-8 col-sm-10 mb-5 mt-3" style="box-shadow: 1px 2px 5px 6px rgba(0,0,0,0.54);">
            <div class="card-body d-flex flex-column" style="background-color: #d9d9d9;">
                <h3 class="card-title fs-3 fw-bold text-center mt-3">Login</h3>
                <form action="{{ route('login.auth') }}" method="POST" class="card-body py-4 needs-validate">
                    ...
                    <div class="row">
                        <div class="col d-flex flex-column justify-content-center align-items-center">
                            <button type="submit" class="btn fw-semibold mt-3 mb-1" style="background-color: #657b00; color: #ffffff; width: 100%; border-radius: 20px;">Login</button>
                            <p>Don't have an account yet? <a href="{{ route('register') }}" style="text-decoration: none; color: #0037fc;">Register</a></p>
                        </div>
                    </div>
                </form>
            </div>
